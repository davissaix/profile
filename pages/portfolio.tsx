      ...
      <div className="container mx-auto px-4 md:px-0 mt-10">
        ...
        <div className="project-section grid md:grid-cols-3 gap-6">
          ...
          <div className="project bg-gray-100 p-6 rounded-lg shadow-md">
            <img src="/trans.png" alt="Multi-language Translator Preview" className="w-full mb-4 rounded"/>
          ...
          <div className="project bg-gray-100 p-6 rounded-lg shadow-md">
            <img src="/cora.png" alt="3D Web Experience Preview" className="mb-4 rounded"/>
          ...
          <div className="project bg-gray-100 p-6 rounded-lg shadow-md">
            <img src="/luces.png" alt="Svelte Music Visualizer Preview" className="mb-4 rounded"/>
